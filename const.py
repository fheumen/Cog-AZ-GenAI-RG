...
UPLOAD_TMP_PATH = "/dbfs/mnt/FileStore/inputs/tmp"  ### intput directory, where all files uploaded by the user are temporarily saved
OUTPUTS_PATH = (
    "/dbfs/mnt/FileStore/outputs"  ### output directory, where all output files are save
)
...
section_names = [
    ...
    "Recalls, Stock recoveries, Field Alert",
...
section_pattern = [
    ...
    r"Batches Reviewed",
    r"Reprocessed",
    r"Product Reviews from",
    r"Starting and Packaging Materials",
    r"Analytical Data",
    r"Changes",
    r"Stability data",
    r"Deviations",
    r"Quality Events",
    r"Complaints (Product Quality)",
    r"Recalls, Stock recoveries, Field Alerts",
    r"Returned and salvaged goods",
    r"CONTRACTUAL AGREEMENTS / ARRANGEMENTS",
