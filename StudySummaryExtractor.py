...
if len(list_of_files) > 0:
    ...
    for single_filename in list_of_files:
        ...
        if single_filename.endswith(".docx"):
            ...
            res_code = Extract_Summary(
                doc,
                title_begin="REPROCESSED & REWORKED BATCHES",
                title_end="PRODUCT REVIEWS FROM PREVIOUS MANUFACTURING STAGE",
            )
            print(res_code)
            ...
            if res_code not in [0, 2]:
                ...
                LOG_FILENAME = iSRS_write_in_log(
                    res_code, single_filename, tmp_target_file
                )
