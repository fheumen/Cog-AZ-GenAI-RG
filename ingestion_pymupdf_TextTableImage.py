...
def ingest_pdf(pdf_path, section_names, reporting_period, product_name, single_filename, site_name, output_dir):
    ...
    section_chunks = extract_text_tables_images_by_sections(pdf_path, section_names, reporting_period, product_name, single_filename,  site_name, output_dir)
        ...
        for product_name in list_of_product_name: 
            ...
            for single_filename in list_of_files:
               ...
               if(single_filename.endswith(".pdf")): 
                   ...
                   section_chunks = section_chunks  + (ingest_pdf(filename_to_proceed, section_names, reporting_period, product_name, single_filename, site_name, output_path_images))
               else: 
